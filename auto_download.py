...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--username", default=os.environ.get("WMS_USERNAME") or DEFAULT_WMS_USERNAME)
    p.add_argument("--password", default=os.environ.get("WMS_PASSWORD") or DEFAULT_WMS_PASSWORD)
    p.add_argument("--wh-codes", default=DEFAULT_WH_CODES or "US02")
    ...
    p.add_argument("--channel", default=DEFAULT_CHANNEL, help="物流渠道筛选，例如 TikTok-CBT-US、Upload_Shipping_Label-Speedx")
